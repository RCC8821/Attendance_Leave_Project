...
const LeaveData = () => {
  ...
  useEffect(() => {
    const fetchLeaveData = async () => {
      try {
        const response = await fetch("https://attendance-leave-project-seven.vercel.app/api/getFormData", {
          method: "GET",
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await fetch("https://attendance-leave-project-seven.vercel.app/api/Approve-leave", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
